...
\newcommand{\prospettoSettimanale}{
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \item Condivisione scaletta degli argomenti;
        ...
        \end{itemize}
        \item \textbf{Seconda Settimana - Sottotitolo (20 ore)} 
        \begin{itemize}
            \item Approfondimento di tutte le principali modalità di rappresentazione dei dati in ambito Dashboarding e Analytics;
            \item Studio ed approfondimento del caso di studio.
        \end{itemize}
        \item \textbf{Terza Settimana - Sottotitolo (40 ore)} 
        \begin{itemize}
            \item Sviluppo analisi descrittiva di base in relazione al caso di studio.
        \end{itemize}
        \item \textbf{Quarta Settimana - Sottotitolo (40 ore)} 
        \begin{itemize}
            \item Studio dei moduli avanzati di Machine Learning ed Advanced Analytics;
            \item Progettazione analisi avanzata applicata al caso di studio.
        \end{itemize}
